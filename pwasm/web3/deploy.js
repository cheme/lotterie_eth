...
var TokenDeployTransaction = TokenContract.deploy({data: codeHex, arguments: []});

// Will create TokenContract with `totalSupply` = 10000000 and print a result
web3.eth.personal.unlockAccount(web3.eth.defaultAccount, "user").then(() => TokenDeployTransaction.estimateGas()).then(gas => 
//     {
  //      console.log("gas : " + gas);
        TokenDeployTransaction.send({gasLimit: gas, from: web3.eth.defaultAccount})
//;}
).then(contract => { 
